...
THREAD_VALUES = [1, 2, 4, 8, 16] #TODO: not forget to change it on bigger mahcine
K_VALUE = 31
#RAM_GB = 32
H_VALUE = 4
REPEATS = 1
BLOOM_BITS_VALUE = 2**38 #TODO: not forget to change it on the other machine to fill 32Go
BUILD_FIRST = True
...
def plot_rows(rows: list[dict[str, object]], output_path: Path) -> None:
    ...
    fig.suptitle("Number of threads sweep")
    fig.tight_layout()
